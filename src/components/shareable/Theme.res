...
let styleSheets = {
  light: {
    ...
    "textLightOnBackground": textStyle(~color=Colors.light.textLightOnBackground, ()),
    "textVeryLightOnBackground": textStyle(~color=Colors.light.textVeryLightOnBackground, ()),
    "textLightOnBackgroundDark": textStyle(~color=Colors.light.textLightOnBackgroundDark, ()),
  ...
  dark: {
    ...
    "textVeryLightOnBackground": textStyle(~color=Colors.dark.textVeryLightOnBackground, ()),
    "textLightOnBackground": textStyle(~color=Colors.dark.textLightOnBackground, ()),
    "textLightOnBackgroundDark": textStyle(~color=Colors.dark.textLightOnBackgroundDark, ()),
